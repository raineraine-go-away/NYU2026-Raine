...
#if USE_VTF
    UNITY_DOTS_INSTANCED_PROP_OVERRIDE_SUPPORTED(uint,     unity_VTFStride)
#endif
...
#if defined(USE_VTF)
#define unity_LightmapST            LoadLightMapFromTex(UNITY_DOTS_INSTANCED_METADATA_NAME(float4, unity_LightmapST))
#else
...
#if defined(USE_VTF)
#define UNITY_SETUP_DOTS_VTF_STRIDE SetupDOTSInstanceVTFStride(UNITY_DOTS_INSTANCED_METADATA_NAME(uint, unity_VTFStride))
#else
#define UNITY_SETUP_DOTS_VTF_STRIDE 
#endif

#if defined(USE_VTF)
#define UNITY_SETUP_DOTS_SH_COEFFS  SetupDOTSSHCoeffsFromTex(UNITY_DOTS_INSTANCED_METADATA_NAME(SH, unity_SHCoefficients))
#else
