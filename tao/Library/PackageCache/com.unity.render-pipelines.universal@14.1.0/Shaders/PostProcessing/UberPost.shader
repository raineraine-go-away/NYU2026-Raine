Shader "Hidden/Universal Render Pipeline/UberPost"
{
    HLSLINCLUDE
        ...
        half4 FragUberPost(Varyings input) : SV_Target
        {
            ...
            half4 srcColor = SAMPLE_TEXTURE2D_X(_BlitTexture, sampler_LinearClamp, SCREEN_COORD_REMOVE_SCALEBIAS(uvDistorted));
            half3 color = srcColor.xyz;
            ...
            #if UNITY_COLORSPACE_GAMMA
            {
                ...
                #if _PRESERVE_ALPHA && !defined(BLOOM)  // when BLOOM is defined, srcColor gets overriden anyway, so don't bother to convert here
                    srcColor = GetSRGBToLinear(srcColor);
                #endif
            }
            #endif
            ...
            #if _GAMMA_20 && !UNITY_COLORSPACE_GAMMA
            {
                ...
                #if _PRESERVE_ALPHA
                    srcColor = LinearToGamma20(srcColor);
                #endif
            }
            // Back to sRGB
            #elif UNITY_COLORSPACE_GAMMA || _LINEAR_TO_SRGB_CONVERSION
            {
                ...
                #if _PRESERVE_ALPHA
                    srcColor = GetLinearToSRGB(srcColor);
                #endif
            }
            #endif
            ...
            #if _PRESERVE_ALPHA
                color.rgb = lerp(srcColor.rgb, color.rgb, saturate(srcColor.a));
            #endif
