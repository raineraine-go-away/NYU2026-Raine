Shader "Hidden/Universal Render Pipeline/BokehDepthOfField"
{
    HLSLINCLUDE
        ...
        half4 FragComposite(Varyings input) : SV_Target
        {
            ...
            half4 finalColor = lerp(color, half4(dof.rgb, alpha), ffa + dof.a - ffa * dof.a);

        #if _PRESERVE_ALPHA
            finalColor.a = color.a; // preserve alpha from original color
            finalColor.rgb = (color.a > 0) ? finalColor.rgb : color.rgb;
        #endif
