...
- Added support for [Screen Space Ambient Occlusion](https://docs.unity.cn/cn/Packages-cn/com.unity.render-pipelines.universal@latest/manual/post-processing-ssao.html) and a new shader variant _SCREEN_SPACE_OCCLUSION.
...
- Added new sections to documentation: [Writing custom shaders](https://docs.unity.cn/cn/Packages-cn/com.unity.render-pipelines.universal@latest/manual/writing-custom-shaders-urp.html), and [Using the beginCameraRendering event](https://docs.unity.cn/cn/Packages-cn/com.unity.render-pipelines.universal@latest/manual/using-begincamerarendering.html).
