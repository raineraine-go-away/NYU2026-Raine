...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        internal static class Styles
        {
            ...
            public static GUIContent msaaHighQualityText = EditorGUIUtility.TrTextContent("High Quality (MSAA)", "Enables High Quality of GLES MSAA. Only works on the GLES API and requires the Opaque Texture to be enabled.");
