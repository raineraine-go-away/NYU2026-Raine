...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal partial class UniversalRenderPipelineAssetUI
    {
        ...
        static void DrawQuality(SerializedUniversalRenderPipelineAsset serialized, Editor ownerEditor)
        {
            ...
            EditorGUI.BeginDisabledGroup(!serialized.requireOpaqueTextureProp.boolValue);
            EditorGUILayout.PropertyField(serialized.msaaHighQuality, Styles.msaaHighQualityText);
            if (serialized.msaaHighQuality.boolValue)
                EditorGUILayout.HelpBox("Enabling High Quality (MSAA) will increase memory usage and bandwidth consumption. Additionally, it is only supported on the GLES API and requires the Opaque Texture to be enabled.", MessageType.Warning);
            EditorGUI.EndDisabledGroup();
