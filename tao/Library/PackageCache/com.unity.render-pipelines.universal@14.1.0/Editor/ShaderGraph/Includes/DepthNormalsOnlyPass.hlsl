...
)
{
    ...
    SurfaceDescription surfaceDescription = BuildSurfaceDescription(unpacked);
        ...
        #endif
        #if _SMOOTHNESS_IN_NORMALPASS_OFF
            outNormalWS = half4(NormalizeNormalPerPixel(normalWS), 0);
        #else
            outNormalWS = half4(NormalizeNormalPerPixel(normalWS), saturate(surfaceDescription.Smoothness));
        #endif
    #endif
