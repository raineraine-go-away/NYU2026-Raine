...
For information on converting assets made for a Built-in Render Pipeline project to assets compatible with URP, refer to the page [Render Pipeline Converter](https://docs.unity.cn/cn/Packages-cn/com.unity.render-pipelines.universal@latest/manual/features/rp-converter.html).
...
The Universal Renderer is now using [the RTHandle system](https://docs.unity.cn/cn/Packages-cn/com.unity.render-pipelines.core@latest/manual/rthandle-system.html) for its internal targets and in its internal passes.
