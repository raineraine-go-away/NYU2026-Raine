...
namespace UnityEditor.ShaderGraph.Internal
{
    ...
    internal struct HLSLProperty
    {
        ...
        public Action<ShaderStringBuilder, int> customGBufferSplatDeclaration;
        ...
        public HLSLProperty(HLSLType type, string name, HLSLDeclaration declaration, ConcretePrecision precision = ConcretePrecision.Single)
        {
            ...
            this.customGBufferSplatDeclaration = null;
        }
        ...
        public void AppendTo(ShaderStringBuilder ssb, ref int index)
        {
            ...
            {
                // Actually in CBuffer, there is no action for this kind of situation.
                AppendTo(ssb);
            }
            else
            {
                // In CBuffer, only VirtualTexture need HLSLType._CUSTOM to declare variables.
                customGBufferSplatDeclaration(ssb, index);
            }
            index++;
        }
        ...
        public void AppendTo(ShaderStringBuilder ssb, bool isVirtualGeometry)
        {
            ...
            // No needed action to do with else situations.
        }
