...
namespace UnityEditor.ShaderGraph
{
    ...
    class TransformNode : AbstractMaterialNode, IGeneratesBodyCode, IMayRequireTangent, IMayRequireBitangent, IMayRequireNormal, IMayRequireTransform, IMayRequirePosition, IMayRequireVG
    {
        ...
        private ShaderStageCapability m_StageCapability = ShaderStageCapability.None;
        ...
        internal SpaceTransform spaceTransform => new SpaceTransform(conversion.from, conversion.to, conversionType, normalize, sgVersion, m_StageCapability);
