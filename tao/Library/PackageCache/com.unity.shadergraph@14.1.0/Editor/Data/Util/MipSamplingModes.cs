...
namespace UnityEditor.ShaderGraph
{
    ...
    internal static class MipSamplingModesUtils
    {
        ...
        public static string Get2DTextureSamplingMacro(Texture2DMipSamplingMode mode, bool usePlatformMacros, bool isArray, bool isRequireVG = false)
        {
            if (isArray)
            {
                if (usePlatformMacros)
                {
                    switch (mode)
                    {
                        case Texture2DMipSamplingMode.Standard:
                            return isRequireVG ? "PLATFORM_SAMPLE_TEXTURE2D_ARRAY_GRAD" : "PLATFORM_SAMPLE_TEXTURE2D_ARRAY";
                ...
                else
                {
                    ...
                    {
                        case Texture2DMipSamplingMode.Standard:
                            return isRequireVG ? "SAMPLE_TEXTURE2D_ARRAY_GRAD" : "SAMPLE_TEXTURE2D_ARRAY";
                        case Texture2DMipSamplingMode.LOD:
            ...
            else
            {
                if (usePlatformMacros)
                {
                    ...
                    {
                        case Texture2DMipSamplingMode.Standard:
                            return isRequireVG ? "PLATFORM_SAMPLE_TEXTURE2D_GRAD" : "PLATFORM_SAMPLE_TEXTURE2D";
                        case Texture2DMipSamplingMode.LOD:
                ...
                else
                {
                    ...
                    {
                        case Texture2DMipSamplingMode.Standard:
                            return isRequireVG ? "SAMPLE_TEXTURE2D_GRAD" : "SAMPLE_TEXTURE2D";
                        case Texture2DMipSamplingMode.LOD:
