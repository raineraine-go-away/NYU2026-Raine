...
namespace UnityEditor.ShaderGraph
{
    ...
    [Serializable]
    class SlotRequireVGTiling
    {
        public int slotId;
        public VGTiling vgTiling;
    }
    ...
    class SubGraphAsset : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        // For serialization
        public List<SlotRequireVGTiling> outputVGTilings = new List<SlotRequireVGTiling>();
        ...
        private Dictionary<int, VGTiling> m_OutputVGTilings = new Dictionary<int, VGTiling>();
        ...
        public VGTiling GetOutputSlotVGTiling(int slotId)
        {
            if (m_OutputVGTilings.TryGetValue(slotId, out VGTiling vgTiling))
                return vgTiling;
        ...
        internal void LoadVGTilingData()
        {
            m_OutputVGTilings.Clear();
            foreach (var outputVGTiling in outputVGTilings)
            {
                m_OutputVGTilings.Add(outputVGTiling.slotId, outputVGTiling.vgTiling);
            }
        }
    }
}
