namespace UnityEditor.ShaderGraph
{
    ...
    internal static class StructFields
    {
        ...
        public struct SurfaceDescriptionInputs
        {
            ...
            public static FieldDescriptor ddxddyUV0 = new FieldDescriptor(SurfaceDescriptionInputs.name, "ddxddyUV0", "", ShaderValueType.Float4,
                subscriptOptions: StructFieldOptions.Optional);
            public static FieldDescriptor ddxddyUV1 = new FieldDescriptor(SurfaceDescriptionInputs.name, "ddxddyUV1", "", ShaderValueType.Float4,
                subscriptOptions: StructFieldOptions.Optional);
            public static FieldDescriptor ddxddyUV2 = new FieldDescriptor(SurfaceDescriptionInputs.name, "ddxddyUV2", "", ShaderValueType.Float4,
                subscriptOptions: StructFieldOptions.Optional);
            public static FieldDescriptor ddxddyUV3 = new FieldDescriptor(SurfaceDescriptionInputs.name, "ddxddyUV3", "", ShaderValueType.Float4,
                subscriptOptions: StructFieldOptions.Optional);
